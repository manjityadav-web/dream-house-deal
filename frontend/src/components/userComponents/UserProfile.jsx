...
const UserProfile = () => {
  ...
  const [showForm, setShowForm] = useState(false);  // initially form hidden
  ...
  const handleUpdate = async (data) => {
    ...
    const result = await axios.put('https://dream-house-deal-1.onrender.com/api/user-update', formdata, {
      headers: {
    ...
    <>
      ...
      <center>
        <div className='pt-5 profile-container'>
          <h1 className='text-danger mb-5'>User Profile</h1>
           <div className='profile'>
       
        <div className='profile-img'>
          <img src={`https://dream-house-deal-1.onrender.com/img/${data?.profile}`} alt="" className='img-fluid'/>
        </div>
      ...
      <div className="container mt-3">
        ...
        {showForm && (
          <div className="profile-containers mb-5">
            ...
            <div className="register">
              ...
              <div className="inner-register">
                <form onSubmit={handleSubmit((e) => { handleUpdate(e) })}>
                  ...
                  <div className="row">
                    <center> <input type='submit' className='register-submit' value="Update" /></center>
                  </div>
                </form>
              </div>
            </div>
