        ...
        <div className="inner-register">
          ...
          <div className="row">
            <div className="col-sm-12 col-md-6">
              ...
              <div className='d-flex mb-3'>
                <div className='fs-2 icn-bg  icons p-1'><RiMoneyRupeeCircleFill /></div>
                <input type="text" placeholder='Enter Price' className='fs-5 form-control rounded-0  input-radius' {...register('bedroom')} />
             ...
             <div className="col-sm-12 col-md-6">
              ...
              <div className='d-flex mb-3'>
                <div className='fs-2 icn-bg icons   p-1'><FaRegImage /></div>
                <input type="file" className='fs-5 form-control rounded-0  input-radius'   {...register('bathroom')}/>
