...
const Footer = () => {
  ...
  <div className="footer">
    ...
    <div className="first-col">
      ...
      <p><FaLocationDot className='fs-2'/>Bangra Bazar Deoria (U.P)</p>
      <p><IoCall  className='fs-2'/>+91 9628337556</p>
      <p><MdEmail  className='fs-2'/>manjityadav9986@gmail.com</p>
      <p> <a href="https://www.facebook.com/profile.php?id=100055047545455"><FaFacebookF className=' ms-4 fs-2 text-light'/></a> 
